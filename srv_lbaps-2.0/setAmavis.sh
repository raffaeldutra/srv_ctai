...
# queremos descomentar as linhas, foda né ? hehe, sed é o cara
...
# deixando ao utilizador a escolha das acusações a realizar. As configurações
# personalizadas são guardadas no ficheiro:
